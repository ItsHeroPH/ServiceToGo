            ...
            { isOwner ? (
                <div className="w-full h-fit flex items-end gap-2">
                    <div className="w-full h-fit flex flex-col items-end gap-1">
                        <p className="text-sm text-citrus-orange font-medium">You • {dateString}</p>
                        <div className="bg-slate-200 w-fit h-fit p-2 rounded-lg shadow-lg">
                            <p className="text-md text-citrus-orange font-medium">{data.message}</p>
                        </div>
                    </div>
                ...
                <div className="w-full h-fit flex items-start gap-2">
                    ...
                    <div className="w-full h-fit flex flex-col items-start gap-1">
                        <p className="text-sm text-citrus-orange font-medium">{user.username} • {dateString}</p>
                        <div className="bg-slate-200 w-fit h-fit p-2 rounded-lg shadow-lg">
                            <p className="text-md text-citrus-orange font-medium">{data.message}</p>
                        </div>
                    </div>
