...
export default function Verify({ email, onNext = ({}) => {}}) {
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <button className={`${isLoading || isValid ? "bg-citrus-rose/50 pointer-events-none" : "bg-citrus-rose cursor-pointer pointer-events-auto"} select-none w-full rounded-lg p-1 text-lg text-citrus-peach-light font-bold`}
                onClick={async() => {
                    setIsLoading(true);
